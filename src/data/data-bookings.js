...
export const bookings = [
  ...
  // Add these to your bookings array
  {
    created_at: fromToday(-3, true),
    startDate: fromToday(1), // Check-in Tomorrow
    endDate: fromToday(5),
    roomId: 2,
    guestId: 25,
    hasBreakfast: true,
    observations: "Requesting a room with a view if possible.",
    isPaid: true,
    numGuests: 2,
  },
  {
  ...
  },
  {
    ...
    guestId: 27,
    hasBreakfast: true,
    observations: "Arriving via airport shuttle.",
    isPaid: false,
    numGuests: 1,
  },
  {
    created_at: fromToday(-5, true),
    startDate: fromToday(2), // Check-in Day After
    endDate: fromToday(6),
    roomId: 3,
    guestId: 28,
    hasBreakfast: true,
  ...
  },
  {
    created_at: fromToday(-8, true),
    startDate: fromToday(-1),
    endDate: fromToday(2), // Check-out Day After
    roomId: 4,
    guestId: 29,
    hasBreakfast: false,
    observations: "",
  ...
  },
  {
    ...
    guestId: 30,
    hasBreakfast: true,
    observations: "Needs extra towels.",
    isPaid: false,
    numGuests: 3,
  },
];
